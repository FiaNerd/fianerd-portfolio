...
const HeroSection = () => {
  ...
  return (
    <div className="relative mb-8 font-heading bg-[url('/assets/images/bg-light-img.jpg')] dark:bg-[url('/assets/images/bg-dark-img.jpg')] max-w-full h-full md:grid md:grid-cols-2">
