...
const PortfolioHeorIntro = () => {
  ...
  return (
    <div className="max-w-screen-7xl mx-auto px-4 md:px-12 py-8 grid grid-row-1 lg:grid-cols-[50%_40%] 2xl:grid-cols-[40%_30%] gap-8 lg:gap-20 items-center justify-center">
      <div className="flex flex-col justify-center items-center text-center gap-4md:gap-8">
        <div className="flex flex-col lg:gap-8 md:border-double md:border-4 py-8 px-0 md:px-8 border-[#f3d758] dark:border-[#d85f2d] rounded">
          ...
          <div className="flex flex-col w-full xl:flex-row items-center mx-auto md:mt-8 gap-12">
            <Button
