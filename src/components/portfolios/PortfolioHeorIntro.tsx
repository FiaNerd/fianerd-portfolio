...
const PortfolioHeorIntro = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 md:px-12 py-8 grid grid-row-1 lg:grid-cols-[50%_40%] 2xl:grid-cols-[40%_30%] gap-8 lg:gap-20 items-center justify-center">
