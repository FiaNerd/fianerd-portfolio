    ...
    <>
      <div className="grid grid-cols-2 gap-4 w-full dark:bg-accent-secondary">
        <div className="grid gap-4 pb-4 pl-4 pt-4 overflow-hidden">
          {/* Image 1 */}
          <div className="relative w-full h-[13em] overflow-hidden bg-no-repeat cursor-zoom-in" onClick={() => openModal(images && images[0] ? images[0] : { src: "", alt: "" })}>
            <img
              className="h-full w-full rounded-lg object-cover object-center transform transition duration-300 ease-in-out hover:scale-110"
          ...
          {/* Image 2 */}
          <div className="relative w-full h-[13em] cursor-zoom-in" onClick={() => openModal(images && images[1] ? images[1] : { src: "", alt: "" })}>
            <img
              className="h-full w-full rounded-lg object-cover object-center transform transition duration-300 ease-in-out hover:scale-110"
          ...
          {/* Image 3 */}
          <div className="relative w-full h-[18em] cursor-zoom-in" onClick={() => openModal(images && images[2] ? images[2] : { src: "", alt: "" })}>
            <img
              className="h-full w-full rounded-lg object-cover object-center transform transition duration-300 ease-in-out hover:scale-110"
        ...
        <div className="grid gap-4 pb-4 pr-4 pt-4 overflow-hidden">
          {/* Image 4 */}
          <div className="relative w-full h-[18em] cursor-zoom-in" onClick={() => openModal(images && images[3] ? images[3] : { src: "", alt: "" })}>
            <img
              className="h-full w-full rounded-lg object-cover object-center transform transition duration-300 ease-in-out hover:scale-110"
          ...
          {/* Image 5 */}
          <div className="relative w-full h-[18em] cursor-zoom-in" onClick={() => openModal(images && images[4] ? images[4] : { src: "", alt: "" })}>
            <img
              className="h-full w-full rounded-lg object-cover object-center transform transition duration-300 ease-in-out hover:scale-110"
          ...
          {/* Image 6 */}
          <div className="relative w-full h-full cursor-zoom-in" onClick={() => openModal(images && images[5] ? images[5] : { src: "", alt: "" })}>
            <img
              className="h-full w-full rounded-lg object-cover object-center transform transition duration-300 ease-in-out hover:scale-110"
