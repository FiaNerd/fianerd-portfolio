...
const GraphicSkills = () => {
  ...
  return (
    <div className="max-w-screen-xl mx-auto px-4 md:px-10 py-8 md:py-12">
      <div 
        className="grid grid-rows-[auto_auto] grid-cols-1 md:grid-cols- gap-8 md:gap-20 mb-8"
      >
        {/* H1 in the first row, first column */}
        <h2 className="text-center text-hover-text bg-[#4b1718]  dark:bg-bg-secondary dark:text-[#4b1718] py-2 md:py-4 px-4 md:col-start-1 md:row-start-1">
      ...
      >
        ...
        <div className="sm:col-span-1 order-last lg:order-none md:pr-8 flex flex-col justify-between	">
           <p className="italic font-medium font-sub-heading underline decoration-wavy text-[#4b1718] dark:text-bg-secondary dark:decoration-text-secondary underline-offset-8 mb-6">{t('graphicSkills.textTitleGraphicGoal')}</p>
