  ...
  return (
    <div className="flex items-center">
      <button
        ...
        className="icon-language rounded-full cursor-pointer focus:outline-none flex items-center text-text-primary hover:text-accent-secondary dark:hover:text-bg-secondary"
      >
        <FontAwesomeIcon
