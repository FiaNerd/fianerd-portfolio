    ...
    <div className="relative font-heading bg-[#e6a65e] dark:bg-[url('/assets/images/bg-dark-img.jpg')] max-w-full md:grid md:grid-cols-2">
      <div className={`flex flex-col absolute md:static inset-0 mx-auto gap-4 md:justify-between md:mx-0 z-10 pl-4 pr-4 sm:pr-[1.3em] md:gap-6 md:pr-8 md:pl-8 md:pt-[1em]`}>
        <motion.div
          ...
          <p className={`${styles['title-fullstack']} text-text-secondary dark:text-[#d57d7d] text-2xl font-light leading-none sm:text-4xl sm:-ml-[0.3em] md:pl-[0.8em] md:text-4xl xl:text-3xl 2xl:text-5xl`}>
            {t('smallTitle')}
          </p>
        ...
        <motion.div
          ...
          <h2 className={`${styles['myName']} text-[#ef273e] dark:text-accent-secondary uppercase text-3xl md:-mt-[0.2em] sm:text-5xl md:text-4xl lg:text-5xl 2xl:text-6xl font-bold text-text-heading tracking-tighter`}>
            {t('name')}
          </h2>
        ...
        <Button className="bg-btn-bg text-bg-primary border-btn-bg hover:border-bg-hover hover:bg-bg-hover py-2 px-4 sm:py-3 sm:px-6 w-full sm:w-auto">
          ...
          <NavLink to="#" className="border-btn-bg text-btn-bg border-2 text-center hover:border-bg-hover tracking-wider hover:bg-bg-hover hover:text-bg-primary py-2 px-4 sm:py-3 sm:px-6 rounded w-full sm:w-auto">
            {t('contact')}
          </NavLink>
        </div>
      </div>
